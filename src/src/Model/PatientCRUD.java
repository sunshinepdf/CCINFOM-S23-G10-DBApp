...
public class PatientCRUD {
    ...
    public void createPatient(Patient p) throws SQLException{
        String sql = "INSERT INTO patient(patientID, lastName, firstName, birthDate, " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            pstmt.setString(9, p.getPatientStatus().getLabel());
    ...
    public void updatePatient(Patient p) throws SQLException {
        ...
        PreparedStatement pstmt = conn.prepareStatement(sql)) {
            ...
            pstmt.setString(8, p.getPatientStatus().getLabel());

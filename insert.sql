...
INSERT INTO facility (facilityName, facilityAddress, facilityContactNum, shiftStart, shiftEnd, facilityStatusID) 
VALUES
('Barangay Health Center Malolos', '123 Mabini Street, Barangay 112, Malolos City', '09171223342', '08:00:00', '17:00:00', 1),
...
INSERT INTO worker (hWorkerLastName, hWorkerFirstName, hWorkerPosition, hContactInformation, hWorkerFacilityID, hWorkerStatusID) 
VALUES	('Dela Cruz', 'Ashanti Mae', 'Day Care Worker', '09171884564', 1, 4),
		...
		('Zamora', 'Jacinto', 'Community Health Aide', '09215678901', 7, 4),
...
INSERT INTO patient (lastName, firstName, birthDate, gender, bloodType, address, primaryPhone, emergencyContact, patientStatus) 
VALUES	('Santos', 'Juliet', '1989-05-26', 'Female', 'O+', '75 Rizal Avenue, Barangay 112, Malolos City', '09171233367', 'Romeo Santos - 09171734567', 6),
		...
		('Kollet', 'Gabriel Will', '1970-10-03', 'Male', 'A+', '654 Onyx Street, Barangay 192, Sta. Ana City', '092601119821', 'Teresa Kollet - 09260123113', 6);

INSERT INTO supplier (supplierName, supplierAddress, supplierContactNum, supplierType, deliveryLeadTime, transactionDetails, supplierStatusID) 
...
INSERT INTO medical_consultation (patientID, hWorkerID, facilityID, consultationDate, consultationTime, symptoms, diagnosis, prescription, consultationStatusID) 
VALUES	(1, 1, 1, '2024-11-15', '09:30:00', 'Fever, headache, body aches for 2 days', 'Acute viral infection', 'Paracetamol 500mg, 1 tablet every 6 hours for 3 days. Increase fluid intake and rest.', 17),
		...
		(4, 7, 4, '2024-11-18', '11:15:00', 'Frequent urination, increased thirst, fatigue', 'Type 2 Diabetes Mellitus - follow up', 'Continue Metformin 500mg twice daily. Monitor blood sugar levels. Schedule follow-up in 1 month.', 17),
		(5, 9, 5, '2024-11-18', '15:45:00', 'Difficulty breathing, wheezing, chest tightness', 'Acute asthma exacerbation', 'Salbutamol syrup 5mL every 6 hours as needed. Advise to avoid triggers. Emergency referral if worsens.', 17),
		(6, 10, 6, '2024-11-19', '08:30:00', 'Abdominal pain, bloating, acid reflux', 'Gastroesophageal reflux disease (GERD)', 'Omeprazole 20mg, 1 capsule once daily before breakfast for 14 days. Avoid spicy foods and late meals.', 18),
		(7, 5, 7, '2024-11-25', '13:00:00', 'Routine check-up, no complaints', 'Healthy - routine examination', 'No prescription needed. Maintain healthy lifestyle. Annual check-up recommended.', 17),
		(8, 3, 2, '2024-12-04', '16:00:00', 'High fever, severe headache, muscle pain', 'Suspected dengue fever', 'Paracetamol for fever. Increase fluid intake. Complete blood count ordered. Refer to hospital if platelet count drops.', 19),
		(9, 6, 3, '2024-12-19', '10:30:00', 'Joint pain, swelling in knees', 'Osteoarthritis', 'Ibuprofen 400mg, 1 tablet twice daily after meals. Apply warm compress. Physical therapy recommended.', 18),
		(10, 1, 1, '2024-12-22', '14:00:00', 'Persistent cough with phlegm, chest discomfort', 'Acute bronchitis', 'Lagundi syrup 10mL three times daily. Amoxicillin 500mg three times daily for 5 days. Follow-up in 1 week.', 19);

INSERT INTO prescription_receipt (patientID, consultationID, medicineID, hWorkerID, distributionDate, qtyDistributed, isValidPrescription, inventoryUpdated, prescriptionStatusID) 
VALUES	(1, 1, 1, 1, '2024-11-15', 18, TRUE, TRUE, 20),  
		(2, 2, 2, 3, '2024-11-16', 21, TRUE, TRUE, 20),   
		(2, 2, 8, 3, '2024-11-16', 1, TRUE, TRUE, 20),    
		(3, 3, 3, 6, '2024-11-17', 7, TRUE, TRUE, 20),    
		(4, 4, 4, 7, '2024-11-18', 60, TRUE, TRUE, 20),  
		(5, 5, 5, 9, '2024-11-18', 1, TRUE, TRUE, 20),    
		(6, 6, 7, 10, '2024-11-19', 14, TRUE, FALSE, 21),
		(9, 9, 6, 6, '2024-12-19', 14, TRUE, FALSE, 21),  
		(10, 10, 8, 1, '2024-12-22', 1, TRUE, TRUE, 20), 
		(10, 10, 2, 1, '2024-12-22', 15, TRUE, TRUE, 20); 

INSERT INTO immunization_administration (patientID, medicineID, hWorkerID, administrationDate, vaccineType, dosageNumber, nextVaccinationDate, immunizationStatus, sideEffects) 
...
INSERT INTO restock_invoice (supplierID, purchaseOrderID, deliveryDate, receivedBy, totalOrderCost, deliveryStatus) 
VALUES	(1, 'PO-2024-001', '2024-10-15', 1, 125000.00, 26), 
		(2, 'PO-2024-002', '2024-10-20', 3, 45000.00, 26),  
		(3, 'PO-2024-003', '2024-11-05', 6, 85000.00, 26),   
		(4, 'PO-2024-004', '2024-11-10', 7, 67500.00, 26),  
		(5, 'PO-2024-005', '2024-11-18', 9, 32000.00, 26),  
		(6, 'PO-2024-006', '2024-12-01', 10, 150000.00, 27),
		(2, 'PO-2024-007', '2024-12-10', 3, 38000.00, 28),   
		(5, 'PO-2024-008', '2024-12-15', 1, 28500.00, 30),
		(8, 'PO-2024-009', '2024-11-25', 6, 52000.00, 26),  
		(9, 'PO-2024-010', '2024-12-05', 7, 95000.00, 26);

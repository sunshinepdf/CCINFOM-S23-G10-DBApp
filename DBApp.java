...
public class DBApp {
    ...
    private void initializeGUI(String userName) {
        ...
        // Only the 5 core record management panels
        contentPanel.add(createDashboardPanel(userName), "DASHBOARD");
    ...
    private JPanel createDashboardPanel(String userName) {
        ...
        panel.add(new JLabel("Dashboard - Welcome " + userName));
        return panel;
    }

    private JPanel createPatientRecordsPanel() {
        JPanel panel = new JPanel();
        panel.add(new JLabel("Patient Records"));
        return panel;
    }

    private JPanel createMedicineInventoryPanel() {
        JPanel panel = new JPanel();
        panel.add(new JLabel("Medicine Inventory"));
        return panel;
    }

    private JPanel createHealthWorkerRecordsPanel() {
        JPanel panel = new JPanel();
        panel.add(new JLabel("Health Worker Records"));
        return panel;
    }

    private JPanel createFacilityRecordsPanel() {
        JPanel panel = new JPanel();
        panel.add(new JLabel("Facility Records"));
        return panel;
    }

    private JPanel createSupplierRecordsPanel() {
        JPanel panel = new JPanel();
        panel.add(new JLabel("Supplier Records"));
        return panel;
    }
